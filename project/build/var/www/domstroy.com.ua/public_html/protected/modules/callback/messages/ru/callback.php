...
return [
    ...
    'Callback request' => 'Запрос на обратный звонок от клиента с портала ДомСтрой',
    ...
    'Request a call back' => 'Связаться с продавцом',//Заказать обратный звонок
    ...
    'URL' => 'Обьявление',
    'Top text' => 'Добрый день! Покупатель заинтересовался Вашим обьявлением и запросил обратный звонок. Перезвоните ему.',
    'Bottom text' => 'С уважением команда ДомСтрой',
];