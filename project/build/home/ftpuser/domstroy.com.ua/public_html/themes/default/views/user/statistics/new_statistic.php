...
<div class="row" style="margin-top: 20px;margin-bottom: 20px;">
    <input type="hidden" id="type_statistic" value="g">
    <div class="col-sm-4"><span>Вид:</span></div>
    <div class="col-sm-2 active" id="sel_graphic"><p style="border:1px solid #c24627;text-align: -webkit-center;padding: 3px;" onclick="SelectGraphic()">График</p></div>
    <div class="col-sm-2 no_active" id="sel_table"><p style="border:1px solid #c24627;text-align: -webkit-center;padding: 3px;" onclick="SelectTable()">Таблица</p></div>
</div>
...
<div class="row">
    <input type="hidden" id="type_select" value="s_1">
    <div class="col-sm-2 active" id="s_1"><p  style="border:1px solid #c24627;padding: 3px;text-align: -webkit-center;" data-type="s_1" onclick="SelectTypeSelect(this)">Общая статистика</p></div>
    <div class="col-sm-2 no_active" id="s_2"><p  style="border:1px solid #c24627;padding: 3px;text-align: -webkit-center;" data-type="s_2" onclick="SelectTypeSelect(this)">Просмотры компании</p></div>
...
<p id="text_legend" style="color: #000635;font-size: 16px;font-weight: bold;text-align: center;">Общая статистика за последние 30 дней1</p>
<div class="row">
