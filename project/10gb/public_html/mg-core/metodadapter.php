...
function mgImageProduct($data){
  ...
  return '<img itemprop="image" class="mg-product-image" data-transfer="true" data-product-id="'.$data["id"].'" src="'.$src.'" alt="'.$imagesData["image_alt"].'" title="'.$imagesData["image_title"].'" data-magnify-src="'.$srcLarge.'">';
}
