...
<div class="mg-product-slides">
    ...
    <ul class="main-product-slide">
        ...
        foreach ($data["images_product"] as $key=>$image){?>
            <?php //var_dump($image); ?>
            <li  class="product-details-image"><a href="<?php echo $image; ?>" rel="gallery" class="fancy-modal">
            <?php
        ...
        <div class="slides-inner">
            ...
            ?>
              <a data-slide-index="<?php echo $key?>" class="slides-item" href="javascript:void(0);">
                <img class="mg-peview-foto"  src="<?php echo $image ?>" alt="<?php echo $data["images_alt"][$key];?>" title="<?php echo $data["images_title"][$key];?>"/>
              </a>
            <?php }?>
        </div>
    </div>
